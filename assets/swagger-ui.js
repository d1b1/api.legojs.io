...
function program13(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n								\n								";
  stack1 = helpers.each.call(depth0, depth0.customFields, {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n								\n                <form accept-charset='UTF-8' class='sandbox'>\n                    <div style='margin:0;padding:0;display:inline'></div>\n                    ";
  stack1 = helpers['if'].call(depth0, depth0.parameters, {hash:{},inverse:self.noop,fn:self.program(7, program7, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                    ";
  stack1 = helpers['if'].call(depth0, depth0.errorResponses, {hash:{},inverse:self.noop,fn:self.program(9, program9, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                    ";
  stack1 = helpers['if'].call(depth0, depth0.isReadOnly, {hash:{},inverse:self.program(13, program13, data),fn:self.program(11, program11, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                </form>\n                <div class='response' style='display:none'>\n                    <h4>Request URL</h4>\n                    <div class='block request_url'></div>\n                    <h4>Request Header JSON</h4>\n                    <div class='block request_header'></div>\n                    <h4>Response Body</h4>\n                    <div class='block response_body'></div>\n                    <h4>Response Code</h4>\n                    <div class='block response_code'></div>\n                    <h4>Response Headers</h4>\n                    <div class='block response_headers'></div>\n                </div>\n            </div>\n        </li>\n    </ul>\n";
  return buffer;
  });
})();
...
(function() {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.showCustom = function(e) {
      ...
      // authSettings = {
      //   discoveryUrl: 'http://localhost:40001/auth/authtoken',
      //   consumerKey: 'abc123',
      ...
      authSettings = {
        ...
        accessToken: $('#input_accessToken').val(),
        tokenSecret: $('#input_tokenSecret').val()
      };
      
      for (var settingsKey in authSettings) {
        localStorage.setItem(settingsKey, authSettings[settingsKey]);
      }

      return this.trigger('update-swagger-ui', authSettings);
    };
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      var bodyParam, consumes, error_free, form, headerParams, invocationUrl, isFileUpload, isFormPost, map, o, obj, param, paramContentTypeField, prettyJson, responseContentTypeField, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      if (e != null) {
        e.preventDefault();
      }
      ...
      // this.model.customFields.requestSignature
      if (1==1) {
        // Sign it!      
        var fullURL = location.protocol + '//' + location.host + invocationUrl;
        //var fullURL = invocationUrl;

        console.log('invocationUrl', invocationUrl)
        console.log('fullURL', fullURL);

        var accessToken = null, tokenSecret = null;

        //if (this.model.customFields.requestSignature === 'token') {
          accessToken = $('#input_accessToken').val();
          tokenSecret = $('#input_tokenSecret').val();
       // }
        ...
        var authSigningOptions = {
  				url: fullURL,
          requestMethod: this.model.httpMethod,
        ...
        // Sometimes this is not set, so if a null then we have an issue.
        if (obj.headers == null) obj.headers = {};

        obj.headers.Authorization = authutils.makeAuthHeaderFromParamsObject(authParamsObject);
      }
      ;
        prettyJson = JSON.stringify(obj.headers, null, " ");
        $(".request_header", $(this.el)).html("<pre>" + prettyJson + "</pre>");
        jQuery.ajax(obj);
        return false;
      }
    };
